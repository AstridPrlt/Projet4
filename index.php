...
<html lang="fr">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="public/img/logo.png" alt="logo livre"></a><button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Accueil</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="roman.html">Le Roman</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="contact.html">Contact</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="connexion.html">Connexion</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <section class="page-section" id="services">
            <div class="container">
                ...
                <div class="card text-center">
                    <h3 class="card-header">L'heure du départ</h3>
                    <div class="card-body">
                    <!--  <h5 class="card-title">Special title treatment</h5> -->
                      <p class="card-text text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae ipsam quo incidunt. Quae quibusdam molestias dolor maiores maxime, minima similique pariatur assumenda alias ipsam unde ullam perferendis tenetur quod. Expedita?</br>
                      Quidem, doloremque repellendus? Placeat quaerat consequatur non dolorum nemo magnam laborum aliquam repellendus. Ab minus obcaecati quia. Perspiciatis quia deleniti deserunt inventore!
                      </br>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem ea suscipit, nesciunt asperiores, eligendi cum nulla in fugiat eos totam perspiciatis dignissimos nemo et, autem dolores itaque perferendis. Sint, provident.</p>
                      <a href="roman.html" class="btn btn-primary btn-xl">Voir tous les épisodes</a>
                    </div>
                  </div>
                </div>
            </div>
